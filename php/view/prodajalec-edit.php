...
<form action="<?= BASE_URL . "prodajalec/edit" ?>" method="post">
	<p>
        <label>ID: <span class="important"><?= $errors["id"] ?></span><br />
		<textarea name="id" rows="1" cols="10"><?= $izdelek["id"] ?></textarea></label>
	</p>
    <p>
